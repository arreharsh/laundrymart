...
const CallbackPopup = ({ isOpen, onClose }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await fetch('https://script.google.com/macros/s/AKfycbyXdv-3SlbbHingRWfE26g5Y7KFfKgpW8hoon7gq7fUjFb1PFpwmA2mhmONGONGaK8Exw/exec', {
        method: 'POST',
        mode: 'no-cors',
        body: formData,
      });
      ...
      setSuccess(true);
      setMessage("Thank You! We'll get back to you.");
      setTimeout(() => {
        setLoading(false);
